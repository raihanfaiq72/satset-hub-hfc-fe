    ...
    <div class="bg-white min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
        <div class="w-full max-w-[400px] px-8 space-y-8">
            ...
            <form class="space-y-6 animate-fade-in" action="{{ route('login.post') }}" method="POST">
                ...
                <div class="space-y-2">
                    ...
                    <input id="username" name="username" type="text" placeholder="Type Username Here"
                        ...
                        required autocomplete="off" value="{{ old('username') }}" autofocus />
                </div>
            ...
            <div class="pt-8 space-y-4">
                ...
                <a href="/register"
                    class="h-12 w-full border-2 border-satset-green text-satset-green font-bold hover:bg-satset-green/5 rounded-xl transition-colors flex items-center justify-center text-lg no-underline">
                    Daftar Sekarang!
                </a>
            </div>
        </div>
