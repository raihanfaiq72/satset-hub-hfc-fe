...
<body class="bg-gray-50 min-h-screen">
    <div class="flex min-h-screen flex-col">
                    ...
                    <div class="p-8 text-center">
                        <div class="flex justify-center mb-3">
                            <div class="bg-satset-green/10 px-4 py-1.5 rounded-full">
                                <span
                                    class="text-[10px] font-black text-satset-green uppercase tracking-widest">{{ $service['kode'] }} - Rp {{ number_format($service['harga'], 0, ',', '.') ?? 150.000}}</span>
                            </div>
                        </div>
            ...
            <div class="mt-10">
                ...
                <div class="flex gap-4 overflow-x-auto px-6 pb-6 no-scrollbar">
                    ...
                    <div class="gallery-item relative flex-shrink-0 w-36 h-36 rounded-[28px] overflow-hidden shadow-md cursor-pointer border-2 border-white"
                        ...
                        @endif
                        <div class="absolute bottom-3 right-3 h-8 w-8 bg-black/40 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/20">
                            @if($item['type'] === 'image')
        ...
        <div id="zoomModal" class="fixed inset-0 z-50 flex items-center justify-center p-6 overflow-hidden hidden">
            ...
            <!-- Modal Controls -->
            <button onclick="closeZoom()" class="absolute top-8 right-8 z-[60] text-white p-3 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md transition-all">
            ...
            <button onclick="prevZoom()" class="absolute left-6 top-1/2 -translate-y-1/2 z-[60] text-white p-4 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md transition-all shadow-lg">
            ...
            <div class="modal-content relative w-full max-w-5xl h-[70vh] flex flex-col items-center justify-center z-[55]">
            ...
            <button onclick="nextZoom()" class="absolute right-6 top-1/2 -translate-y-1/2 z-[60] text-white p-4 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md transition-all shadow-lg">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round">
