<template id="tpl-step-3">
    <div class="space-y-6 pb-20">
        ...
        <div class="space-y-3">
            ...
            <div id="promoContainer" class="bg-white border-2 border-gray-100 rounded-[24px] p-4 flex items-center justify-between group active:scale-95 transition-all cursor-pointer hover:border-satset-green" onclick="showPromoModal()">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p id="selectedPromoSub" class="text-[10px] text-gray-400 font-bold uppercase">Diskon atau voucher</p>
                    </div>
                </div>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="text-gray-300 group-hover:text-satset-green transition-colors">
        ...
        <div class="space-y-3">
            ...
            <div class="grid grid-cols-1 gap-3">
                <!-- Voucher Pembayaran -->
                <div class="payment-method-card bg-white border-2 border-gray-100 rounded-[28px] p-4 flex items-center gap-4 cursor-pointer transition-all hover:border-satset-green" onclick="selectPaymentMethod('voucher')">
                    <div class="h-12 w-12 bg-satset-green rounded-2xl flex items-center justify-center text-white shrink-0">
                    ...
                    <div class="flex-1">
                        ...
                        <p id="voucherBalanceText" class="text-[10px] text-satset-green font-black uppercase tracking-tighter loading-text">Mengecek voucher...</p>
                    </div>
                    <input type="radio" name="payment_method" value="voucher" class="radio-custom pointer-events-none" id="radio-voucher">
                </div>

                <!-- QRIS -->
                <div class="payment-method-card bg-white border-2 border-gray-100 rounded-[28px] p-4 flex items-center gap-4 cursor-pointer transition-all hover:border-satset-green" onclick="selectPaymentMethod('qris')">
                    <div class="h-12 w-12 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-800 shrink-0">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">Gopay, OVO, ShopeePay, Dana</p>
                    </div>
                    <input type="radio" name="payment_method" value="qris" class="radio-custom pointer-events-none" id="radio-qris">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="promoModal" class="fixed inset-0 z-50 flex items-end justify-center hidden">
        ...
        <div class="relative bg-white rounded-t-[40px] w-full max-w-lg p-6 pb-12 shadow-2xl transition-transform transform translate-y-full" id="promoModalContent">
