            ...
            <div class="w-full">
                ...
                <div id="tabContent" class="tab-content">
                    ...
                    <div id="content-mine" class="space-y-4">
                        <!-- Payment Voucher -->
                        <div
                            class="voucher-card border-none shadow-md rounded-[28px] overflow-hidden bg-satset-green text-white">
                            <div class="p-0 flex h-28">
                                <div
                                    class="w-28 flex flex-col items-center justify-center border-r-2 border-dashed border-white/20">
                                ...
                                <div class="flex-1 p-4 flex flex-col justify-center">
                                    <h4 class="font-black text-lg leading-none">HFC 1 Jam</h4>
                                    <p class="text-[10px] mt-1 font-bold text-white/70">Bisa digunakan untuk semua
                                        layanan HFC</p>
                                    <div class="mt-2 inline-block">
                                        <span
                                            class="text-[10px] font-black px-2 py-0.5 rounded-full bg-white text-satset-green">
                                            X3 Tersedia
                                        </span>
                                    </div>
                                </div>
                        ...
                        <section class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="voucher-card border-none shadow-sm rounded-[32px] overflow-hidden bg-white"
                                    onclick="openPayment({id: 101, title: 'HFC 1 Jam', price: 150000})">
                                    ...
                                    <div class="p-4 space-y-2">
                                        <h4 class="font-black text-gray-800 text-xs leading-tight">HFC 1 Jam</h4>
                                        <p class="text-sm font-black text-satset-green">Rp150.000</p>
                                        <button
                                            class="w-full py-2 bg-gray-50 rounded-xl text-[9px] font-black text-gray-400 hover:bg-satset-green hover:text-white transition-all uppercase">Beli
                                            Satuan</button>
                                    </div>
                                </div>
                                ...
                                <!-- SatSet Clean -->
                                <div class="voucher-card border-none shadow-sm rounded-[32px] overflow-hidden bg-white"
                                    onclick="openPayment({id: 102, title: 'SatSet Clean', price: 75000})">
                                    <div class="relative h-28 w-full bg-gray-100">
                                        <div
                                            class="w-full h-full bg-gradient-to-br from-green-400 to-emerald-500 flex items-center justify-center">
                                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="white"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <path
                                    ...
                                    <div class="p-4 space-y-2">
                                        <h4 class="font-black text-gray-800 text-xs leading-tight">SatSet Clean</h4>
                                        <p class="text-sm font-black text-satset-green">Rp75.000</p>
                                        <button
                                            class="w-full py-2 bg-gray-50 rounded-xl text-[9px] font-black text-gray-400 hover:bg-satset-green hover:text-white transition-all uppercase">Beli
                                            Satuan</button>
                                    </div>
